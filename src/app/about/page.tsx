          ...
          <div className="lg:order-first lg:row-span-2">
            ...
            <div className="text-ctp-subtext1 mt-6 space-y-7 text-base">
              <p>
                ...
                (Django/FastAPI/Wagtail) and TypeScript (React/Next.js). My
                focus is building user-centred products that are accessible,
              ...
              <p>
                Outside work, I climb, ride motorcycles, and spend too much
                money on great food and coffee. I&apos;m based in Bristol, with
                regular stints in London.
              </p>
            </div>
          </div>
          <div className="lg:pl-20">
