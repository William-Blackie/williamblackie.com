        ...
        <div className="space-y-20">
          <ToolsSection title="Core Stack">
            ...
            <Tool title="Data and platform: PostgreSQL, Redis, RQ and Stripe">
              PostgreSQL and Redis for core data and queue workflows, plus
              Stripe for billing systems.
            </Tool>
            <Tool title="Quality and delivery: Pytest, Ruff, ESLint, Stylelint, Prettier">
              Fast feedback loops through testing, linting, and formatting
              checks to keep quality high without blocking delivery.
            </Tool>
